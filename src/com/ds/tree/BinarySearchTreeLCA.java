...
public class BinarySearchTreeLCA {
	...
	{
		BinarySearchTreeLCA bi=new BinarySearchTreeLCA();
		...
		System.out.println("Lowest common ancestor for node 45 and 30 using Iteration:");
		System.out.println(LCAItr(rootNode,node45,node30).data);
