...
public class BinarySearchTreeSortedArrayMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("Preorder traversal of created binary search tree(inOrder) :");
		inOrder(rootNode);
		System.out.println();
		System.out.println("Preorder traversal of created binary search tree(preOrder) :");
		preOrder(rootNode);
